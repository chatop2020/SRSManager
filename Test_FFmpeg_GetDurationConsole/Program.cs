...
namespace Test_FFmpeg_GetDurationConsole
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            FFmpegGetDuration.GetDuration("/usr/local/bin/ffmpeg", "/Users/qiuzhouwei/Downloads/iAETAqNtcDQDAQQABQAG2gAjhAGkC1ijNgKqjQN_hy6n5qQn_APPAAABcjCTN0AEzgAOpOcHzg4ccE0IAA.mp4",out long i);
Console.WriteLine(
